...
export default function LoadGithub({setWorkSpaceMetadata, setCurWorkSpaceID, currentModel, setCurrentUsage}: LoadOutLookProps) {
    const { port } = usePort()
  ...
  return (
    <>
        <Tooltip title="Upcoming">
            ...
            >
                <img src={githubLogo} style={{width: '20px', opacity: '0.2'}} placeholder='Outlook'/>
            </button>
        </Tooltip>
        
        <form onSubmit={(e)=>e.preventDefault()} className="modal fade" id="githubModal" tabIndex={-1} aria-hidden="true">
                    ...
                    <div className="modal-body pt-0">
                        {
                            ...
                            <div className='py-5'>
                                ...
                                <div className="form-check font-sm d-flex justify-content-center mt-5">
                                    <input className="form-check-input me-2" type="checkbox" value="" id="githubCheckbox" 
                                ...
                                <div className='d-flex justify-content-center mt-2'>
                                    ...
                                    >
                                        ...
                                        <img src={githubLogo} style={{width: '20px'}} placeholder='Continue with Github'/>
                                        <div className='ms-2'>
