...
export default function Extraction({ globalSearchStr, searchResults, curWorkSpaceID, setWorkSpaceMetadata }: ExtractionProps) {
  const { port } = usePort()
          ...
          searchResults.map((result, index) => (
                <div key={index} className='extraction font-sm p-4 rounded-3 d-flex align-items-center mb-3'>
                  ...
                  <div>
                    ...
                    <div dangerouslySetInnerHTML={{ __html: highlightText(result.result_text, keywords) }}></div>
